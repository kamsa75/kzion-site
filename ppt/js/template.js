...
const TEMPLATE = [
  ...
  { id: 'prayer-live-1',type: 'green_blank', title: '빈 그린스크린(라이브)', section: null,     source: 'fixed',           removable: false },
  { id: 'prayer',       type: 'green',       title: '기도',                 section: 'pastor', source: 'prayer',          removable: false },
  { id: 'prayer-live-2',type: 'green_blank', title: '빈 그린스크린(라이브)', section: null,     source: 'fixed',           removable: false },
  ...
  { id: 'news-live',    type: 'green_blank', title: '빈 그린스크린(라이브)', section: null,     source: 'fixed',           removable: false },
